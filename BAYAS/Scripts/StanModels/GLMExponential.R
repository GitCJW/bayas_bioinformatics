...
GLMExponentialStanModel <- R6Class(classname = "GLMExponentialStanModel",
                             ...
                             public = list(
                               ...
                               id = 10,
                               brmsClass = T,
                               display_name = 'GLM - Exponential distribution',
                               description = 'The exponential distribution is often used e.g. for time events like the time until a radioactive particle decays.
                                  \nYour response variable should be positive continuous. Zeros are also valid. Please make sure that your (theoretical) limits makes sense.',
                               is.discrete = F,
