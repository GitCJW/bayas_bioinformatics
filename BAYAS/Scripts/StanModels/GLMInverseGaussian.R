...
GLMInverseGaussianStanModel <- R6Class(
  classname = "GLMInverseGaussianStanModel",
  ...
  public = list(
    ...
    id = 7,
    brmsClass = F,
    display_name = 'Inverse normal distribution (GLM)',
    ...
    get_content_for_stan_code = function(response, data, stanParameter){
      ...
      family <- with(env, inverse.gaussian(link="log"))
