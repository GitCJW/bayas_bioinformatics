...
<p>AG Bioinformatics & Computational Biophysics<br />
Universit&auml;tsstr. 1-5<br />
S03<br />
45117 Essen <br /> 
Deutschland </p>
...
<h2>Kontakt</h2>
<p>Telefon: +49 (0) 201 183 -2648<br />
Telefax: +49 (0) 201 183 -3437<br />
E-Mail: christoph.waterkamp@uni-due.de</p>
...
<h3>Haftung f&uuml;r Inhalte</h3> 
  ...
  Nach &sect;&sect; 8 bis 10 TMG sind wir als Diensteanbieter jedoch nicht verpflichtet, &uuml;bermittelte oder gespeicherte fremde Informationen zu &uuml;berwachen oder nach Umst&auml;nden zu forschen, die auf eine rechtswidrige T&auml;tigkeit hinweisen.</p> <p>Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen nach den allgemeinen Gesetzen bleiben hiervon unber&uuml;hrt. 
  ...
  Bei Bekanntwerden von entsprechenden Rechtsverletzungen werden wir diese Inhalte umgehend entfernen.</p> <h3>Haftung f&uuml;r Links</h3> 
  <p>Unser Angebot enth&auml;lt Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb k&ouml;nnen wir f&uuml;r diese fremden Inhalte auch keine Gew&auml;hr &uuml;bernehmen. 
